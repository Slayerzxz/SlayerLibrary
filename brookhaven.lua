    ...
    function Window:MakeTab(paste, Configs)
        ...
        function Tab:AddDropdown(Configs)
            ...
            local function CalculatePos()
                ...
                local DropHeight = DropFrame.Size.Y.Offset
                local ClampY = (FramePos.Y / UIScale) + SelectedFrame.Size.Y.Offset + 2
                if ClampY + DropHeight > ScreenSize.Y / UIScale then
                    ClampY = (FramePos.Y / UIScale) - DropHeight - 2
                end
